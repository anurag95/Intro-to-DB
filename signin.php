  ...
  <body>
     <?php
      ...
      if(isset($_SESSION['views'])){
        echo "<script>alert('You are already logged in'); location.href = 'index.php'</script>";
      }
    ?>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        ...
        <form class="col-md-4 form-signin" role="form" action='scripts/checklogin.php' method='post'>
