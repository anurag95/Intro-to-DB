  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        ...
        <form class="col-md-4 form-signin" role="form" action='scripts/mill.php' method='post'>
          <h2 class="form-signin-heading">Add a new mill - </h2>
          <br />
          <input class="form-control" name='shopname' placeholder='Mill Name' required="" autofocus="" type='text'>
          <br />
